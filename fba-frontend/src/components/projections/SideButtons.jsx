  ...
  return (
    <ul className={classes.container}>
      <li>
        <button
          className={
            props.timePeriod === "Season_2023"
              ? classes.activeButton
              : classes.default
          }
          onClick={() => setTimePeriodHandler("Season_2023")}
        >
          Season
        </button>
      </li>
      <li>
        <button
          className={
            props.timePeriod === "Last_30_2023"
              ? classes.activeButton
              : classes.default
          }
          onClick={() => setTimePeriodHandler("Last_30_2023")}
        >
          Last 30
        </button>
      </li>
      <li>
        <button
          className={
            props.timePeriod === "Last_15_2023"
              ? classes.activeButton
              : classes.default
          }
          onClick={() => setTimePeriodHandler("Last_15_2023")}
        >
          Last 15
        </button>
      </li>
      <li>
        <button
          className={
            props.timePeriod === "Last_7_2023"
              ? classes.activeButton
              : classes.default
          }
          onClick={() => setTimePeriodHandler("Last_7_2023")}
        >
          Last 7
        </button>
      </li>
